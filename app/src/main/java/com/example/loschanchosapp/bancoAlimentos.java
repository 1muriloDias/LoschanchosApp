...
public class bancoAlimentos extends AppCompatActivity {

    private TextInputEditText inputNome;
    private Long usuarioId = 1L; // Aqui você deve definir o ID do usuário
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_endpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(descricaoDoacao)) {
                    Toast.makeText(bancoAlimentos.this, "Por favor, insira sua doação.", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    call.enqueue(new Callback<Doacao>() {
                        ...
                        public void onResponse(Call<Doacao> call, Response<Doacao> response) {
                            if (response.isSuccessful()) {
                                ...
                                Intent intent = new Intent(bancoAlimentos.this, endpage.class);
        ...
        btn_voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(bancoAlimentos.this, saude.class);
                startActivity(intent);
            }
        });
