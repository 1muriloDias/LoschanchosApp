    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_endpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(nome)) {
                    ...
                    Toast.makeText(caoSemFome.this, "Por favor, insira sua doação.", Toast.LENGTH_SHORT).show();
                } else {
                    // Se o campo estiver preenchido, avançar para a próxima tela
                    Intent intent = new Intent(caoSemFome.this, endpage.class);
        ...
        btn_voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(caoSemFome.this, saude.class);
                startActivity(intent);
            }
        });
